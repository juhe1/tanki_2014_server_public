...
class DoubleArmorInventoryItemModel(inventory_item_model.InventoryItemModel):
    ...
    def __init__(self, game_object, client_space, client_object, index, global_model=None):
        cool_down_time_in_sec = server_properties_loader.properties.double_armor_cool_down_time_in_sec
        item_id = server_properties_loader.properties.double_armor_item_id
